...
class ExaminationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create examination" do
    assert_difference("Examination.count") do
      post examinations_url, params: { examination: { course_id: @examination.course_id, expected_at: @examination.expected_at, title: @examination.title } }
    end
  ...
  test "should update examination" do
    patch examination_url(@examination), params: { examination: { course_id: @examination.course_id, expected_at: @examination.expected_at, title: @examination.title } }

...
class MomentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create moment" do
    assert_difference("Moment.count") do
      post moments_url, params: { moment: { category: @moment.category, end_at: @moment.end_at, start_at: @moment.start_at, uid: @moment.uid } }
    end
  ...
  test "should update moment" do
    patch moment_url(@moment), params: { moment: { category: @moment.category, end_at: @moment.end_at, start_at: @moment.start_at, uid: @moment.uid } }
